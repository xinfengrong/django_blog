...
class Article(models.Model):
    ...
    full_content = models.CharField(max_length=10000, blank=True, null=True)
...
class Mark(models.Model):
    ...
    marker_name = models.CharField(max_length=20, blank=True, null=True)
    marker_portrait = models.CharField(max_length=200, blank=True, null=True)
...
class User(models.Model):
    ...
    regtime = models.DateTimeField(auto_now=True,blank=True, null=True)
